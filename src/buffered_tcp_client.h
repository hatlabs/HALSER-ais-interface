#ifndef AIS_INTERFACE_SRC_BUFFERED_TCP_CLIENT_H_
#define AIS_INTERFACE_SRC_BUFFERED_TCP_CLIENT_H_
...
typedef std::shared_ptr<WiFiClient> WiFiClientPtr;
...
#endif  // AIS_INTERFACE_SRC_BUFFERED_TCP_CLIENT_H_
